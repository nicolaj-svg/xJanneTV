...
export function ContactPage() {
  return <div className="site-shell"><Header /><main className="contact-page"><div className="contact-page-inner"><img src="https://cdn.builder.io/api/v1/image/assets%2F843c2c9147174e21a08386d68870f8b1%2F3bdd9b522be04ea8aa28c3f63007e729?format=webp&width=800&height=1200" alt="Contact xJanne" className="contact-title-art" /><div className="contact-card"><div className="contact-icon"><MessageCircle size={30} /></div><div><span className="contact-label">COMMUNITY</span><h1>Discord</h1><p>Werde Teil der xJanne Community. Austausch, Updates und neue Projekte findest du auf Discord.</p></div><a className="contact-status" href="https://discord.gg/C8EvTUG7qR" target="_blank" rel="noreferrer"><span /> Discord beitreten <ArrowUpRight size={15} /></a></div></div></main><Footer /></div>;
}
