...
const sectionContent: Record<string, { image: string; label: string; links: { label: string; href: string; external?: boolean }[] }> = {
  Socials: { image: "https://cdn.builder.io/api/v1/image/assets%2F843c2c9147174e21a08386d68870f8b1%2Faec16121e65a4908a9979850982e9fb7?format=webp&width=800&height=1200", label: "ALLE LINKS", links: [{ label: "Linktree öffnen", href: "https://linktr.ee/xjannetv", external: true }] },
  Projekte: { image: "https://cdn.builder.io/api/v1/image/assets%2F843c2c9147174e21a08386d68870f8b1%2F8421c898a7de468283b88454a2878a27?format=webp&width=800&height=1200", label: "AKTUELLE WELTEN", links: [{ label: "Twitch", href: "https://www.twitch.tv/xjannetv", external: true }, { label: "YouTube Hauptkanal", href: "https://www.youtube.com/@xjannetv", external: true }, { label: "YouTube 2. Kanal", href: "https://www.youtube.com/@xKanneTV", external: true }, { label: "TikTok", href: "https://www.tiktok.com/@xjannetv", external: true }, { label: "TikTok Clips", href: "https://www.tiktok.com/@janne_clips", external: true }] },
  Stream: { image: "https://cdn.builder.io/api/v1/image/assets%2F843c2c9147174e21a08386d68870f8b1%2Fdb67860ef05d445daf98bb9eebb8a36f?format=webp&width=800&height=1200", label: "LIVE AUF TWITCH", links: [{ label: "Linktree öffnen", href: "https://linktr.ee/xjannetv", external: true }] },
